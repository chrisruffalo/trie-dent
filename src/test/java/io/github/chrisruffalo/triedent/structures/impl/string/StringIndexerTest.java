...
class StringIndexerTest {

    @Test
    void atIndex() {
        final StringIndexerFactory factory = new StringIndexerFactory();
        Assertions.assertEquals("b", factory.get("ball").atIndex(0).toString());
        Assertions.assertEquals("a", factory.get("ball").atIndex(1).toString());
        Assertions.assertEquals("l", factory.get("ball").atIndex(2).toString());
        Assertions.assertEquals("l", factory.get("ball").atIndex(3).toString());
    ...
    void iterator() {
        ...
        final StringIndexer indexer = new StringIndexer(test);
        final Iterator<CharSequence> iterator = indexer.iterator();
